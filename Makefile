...
three: main.cpp Interfaz.cpp Interfaz.h lista_pos_Arreglo.cpp lista_pos_Arreglo.h lista_ord_array.cpp lista_ord_array.h lista_index_array.cpp lista_index_array.h algoritmos_lista_pos.cpp algoritmos_lista_pos.h
	g++ main.cpp Interfaz.cpp Interfaz.h lista_pos_Arreglo.cpp lista_pos_Arreglo.h lista_ord_array.cpp lista_ord_array.h lista_index_array.cpp lista_index_array.h algoritmos_lista_pos.cpp algoritmos_lista_pos.h -o start	
	./start
